var EnlighterJS = function(e) {
        ...
        return it(gt, {
            ...
            onClick: function() {
                ! function(e) {
                    ...
                    var o = function() {
                        try {
                            return t.execCommand("copy"), notyf('代码已复制，可贴粘')
                        } catch (e) {
                            return !1
                        }
                    }();
            ...
            onClick: function() {
                ...
                e.document.body.innerHTML = "<pre>" + t + "</pre>", e.document.title = "代码显示 | 倾微科技"
            }
        }))
    }
    function ut(e, t) {
    ...
    function ct(e) {
        ...
        return !0 === r.linehover && n.push("enlighter-hover"), !0 === r.linenumbers && n.push("enlighter-linenumbers"), "scroll" === r.textOverflow && n.push("enlighter-overflow-scroll"), t = it(gt, {
            ...
            tokens: e[0].tokens,
            options: e[0].params
        }), it(ut, null, e[0].code)), r.rawcodeDbclick && t.on("dbclick", s), t
    }
    function yt(e) {
        return it("span", {
            className: "enlighter"
